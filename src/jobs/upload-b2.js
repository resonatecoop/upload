...
export const uploadFile = async (filename, mime, data) => {
  const b2 = new B2({
...
export const uploadPart = (b2, fileId) => {
...
export const uploadParts = async (filename, mime, data) => {
  const profiler = logger.startTimer()
  const b2 = new B2({
    accountId: B2_APPLICATION_KEY_ID,
    applicationKey: B2_APPLICATION_KEY
...
export const uploadB2 = async (job) => {
